# ProbeHero9 Interface Requirements - Revision 2


## 🎯 Module Overview
<!-- NOTE: PH9 is a logical continuation of ProbeHero7 -->
**ProbeHero9 is a VHDL module designed to drive various SCA and FI probes. Conceptually it is similar to a simple signal generator. It is intended to drive two analog outputs in response to a simple `trigger_in` signal.  
...
- [[ProbeHero9-functional-reqs|ProbeHero6 Functional Requirements]]
- [[Probe_Config_pkg|Probe Configuration Package]]
- [[Global_Probe_Table_pkg|Global Probe Table Package]]

<!-- End of requirements refined from PH9-interface-reqs.md -->
