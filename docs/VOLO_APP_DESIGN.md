...
**VoloApp** is a hardware abstraction layer for deploying FPGA applications to Moku platform with human-friendly register interfaces. It provides a clean separation between MCC (Moku Cloud Compile) infrastructure and application logic.
