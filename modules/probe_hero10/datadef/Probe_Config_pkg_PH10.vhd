-- =============================================================================
-- Enhanced Probe Configuration Package - ProbeHero10
-- =============================================================================
-- 
-- COPIED FROM: modules/probe_hero9/datadef/Probe_Config_pkg_PH9.vhd
-- DATE: 2025-01-27
-- PURPOSE: Base data definitions for ProbeHero10 development
-- 
-- NOTE: Adapted for ProbeHero10 with PH10 naming convention
-- =============================================================================
-- 
-- This enhanced package provides probe configuration data types and validation
-- functions for ProbeHero10. It includes comprehensive validation, error handling,
-- and unit hinting for improved type safety and testbench validation.
-- 
-- DEPENDENCIES:
-- - Moku_Voltage_pkg_PH10: For voltage data width and voltage-related constants
--
-- UNIT CONVENTIONS:
...
package Probe_Config_pkg_PH10 is

    -- =========================================================================
    -- System Constants with Unit Documentation
    -- =========================================================================
    -- Note: SYSTEM_VOLTAGE_WIDTH now uses VOLTAGE_DATA_WIDTH from Moku_Voltage_pkg_PH10
    ...
    -- Note: Now uses is_voltage_in_range_safe from Moku_Voltage_pkg_PH10
    ...
    -- Note: Now uses clamp_voltage_safe from Moku_Voltage_pkg_PH10
...
end package Probe_Config_pkg_PH10;

-- =============================================================================
-- Package Body Implementation
-- =============================================================================

package body Probe_Config_pkg_PH10 is
    ...
    begin
        -- Delegate to Moku_Voltage_pkg_PH10 function
...
end package body Probe_Config_pkg_PH10;